...
const allHappy = (arr) => {
  return arr.map(str=> str.includes(':)')).reduce((acc,index)=> {
    if(acc === false) {
      return false
    }else if(index === false) {
      return false
...
const findEvery = (arr, target) => {
  return arr.map(str=> str.includes(target)).reduce((acc,index)=> {
    if(acc === false) {
      return false
    }else if(index === false) {
      return false
...
const unenrollBrook = (arr) => {
  return arr.map(i=> {
    return i.filter(str=> !str.includes('Brook'))
  })
};
...
const sortByDay = (arr) => {
  const results = [];
  results.push(arr.filter(str=> str.includes('Monday')));
  results.push(arr.filter(str=> str.includes('Tuesday')));
  results.push(arr.filter(str=> str.includes('Wednesday')));
  results.push(arr.filter(str=> str.includes('Thursday')));
  results.push(arr.filter(str=> str.includes('Friday')));
  results.push(arr.filter(str=> str.includes('Saturday')));
  results.push(arr.filter(str=> str.includes('Sunday')));
  // console.log(results);
  return results
};
